...
_strlen:
    LOAD O1 O2      # load lenght into O2
    JMP END_STRLEN
...
_strcmp:            # sets the 0 - Flag if they're equal, Carry - Flag if higher
    LOAD O3 O1      # load strlen 1
    LOAD O4 O2      # load strlen 2
    CMP O3 O4
    JNZ END_STRCMP
    JMP STRCMP_LOOP
...
_strcat:
    LOAD O4 O1          # O4 = firstString lenght
    LOAD O5 O2          # O5 = secondStringlenght
    ADD O4 O5           # 04 = combinedStringLenght
    STORE O4 O1         # Write combinedLenght to start of string
